...
export const writeComposite = async (spinner) => {
  ...
  const idealiteProjectCardCollectionv1Schema = readFileSync(
  ...
  console.log('idealiteprojectcardcollectionv1composite', idealiteProjectCardCollectionv1Composite.modelIDs)
