...
var ImageHandler = /** @class */ (function (_super) {
    ...
    ImageHandler.prototype.shouldPreHandle = function (url) {
        var IMAGE_URL_PATTERN = /(https?:\/\/.*\.(?:jpg|jpeg|png|webp))/i;
        return IMAGE_URL_PATTERN.test(url.toString());
    };
    ImageHandler.prototype.preHandle = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var title, content;
            return __generator(this, function (_a) {
                title = url.toString().split('/').pop() || 'Image';
                content = "\n      <html>\n        <head>\n          <title>".concat(title, "</title>\n          <meta property=\"og:image\" content=\"").concat(url, "\" />\n          <meta property=\"og:title\" content=\"").concat(title, "\" />\n          <meta property=\"og:type\" content=\"image\" />\n        </head>\n        <body>\n          <div>\n            <img src=\"").concat(url, "\" alt=\"").concat(title, "\">\n          </div>\n        </body>\n      </html>");
                return [2 /*return*/, Promise.resolve({ title: title, content: content })];
            });
        });
    };
    return ImageHandler;
