...
var WikipediaHandler = /** @class */ (function (_super) {
    __extends(WikipediaHandler, _super);
    function WikipediaHandler() {
        var _this = _super.call(this) || this;
        _this.name = 'wikipedia';
        return _this;
    }
    WikipediaHandler.prototype.shouldPreParse = function (url, dom) {
        return new URL(url).hostname.endsWith('wikipedia.org');
    };
    WikipediaHandler.prototype.preParse = function (url, dom) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                // This removes the [edit] anchors from wikipedia pages
                dom.querySelectorAll('.mw-editsection').forEach(function (e) { return e.remove(); });
                // Remove footnotes
                dom.querySelectorAll('sup[class="reference"]').forEach(function (e) { return e.remove(); });
                // this removes the sidebar
                (_a = dom.querySelector('.infobox')) === null || _a === void 0 ? void 0 : _a.remove();
