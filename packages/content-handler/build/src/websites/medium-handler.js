...
var MediumHandler = /** @class */ (function (_super) {
    ...
    MediumHandler.prototype.shouldPreHandle = function (url) {
        var u = new URL(url);
        return u.hostname.endsWith('medium.com');
    };
    MediumHandler.prototype.preHandle = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    ...
                    return [2 /*return*/, Promise.resolve({ url: res.toString() })];
                }
                catch (error) {
