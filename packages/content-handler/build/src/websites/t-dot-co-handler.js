...
var TDotCoHandler = /** @class */ (function (_super) {
    __extends(TDotCoHandler, _super);
    function TDotCoHandler() {
        var _this = _super.call(this) || this;
        _this.name = 't.co';
        return _this;
    }
    TDotCoHandler.prototype.shouldResolve = function (url) {
        var T_DOT_CO_URL_MATCH = /^https:\/\/(?:www\.)?t\.co\/.*$/;
        return T_DOT_CO_URL_MATCH.test(url);
    };
    TDotCoHandler.prototype.resolve = function (url) {
