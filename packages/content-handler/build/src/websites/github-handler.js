...
var GitHubHandler = /** @class */ (function (_super) {
    ...
    GitHubHandler.prototype.shouldPreParse = function (url, dom) {
        return new URL(url).hostname.endsWith('github.com');
    };
    GitHubHandler.prototype.preParse = function (url, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var body, article, twitterTitle, linkAuthor, author, twitterTitleContent;
            return __generator(this, function (_a) {
                body = dom.querySelector('body');
                article = dom.querySelector('article');
                twitterTitle = dom.querySelector("meta[name='twitter:title']");
                linkAuthor = dom.querySelector("span[itemprop='author']");
                if (body && article) {
                ...
                twitterTitleContent = twitterTitle === null || twitterTitle === void 0 ? void 0 : twitterTitle.getAttribute('content');
